function [J, grad] = neuralCostFunc(init_theta, X, y, lambda, layer_size)
...
Theta1 = reshape(init_theta(1:layer_size * (layer_size + 1)), layer_size, layer_size + 1);
Theta2 = reshape(init_theta(1 + (layer_size * (layer_size + 1)):end), 1, layer_size + 1);
